...
def add_feat():
    ...
    df = df[['date', 'time', 'weather', 'weather_pre1', 'weather_pre2',
             'is_rain_time_slice', 'weather_of_day', 'is_rain_day', 'temperature',
             'temp_change', 'temp_mean_day', 'pm2.5', 'pm2.5_change', 'pm2.5_mean_day']]
